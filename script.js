...
const appPartialTranslationTable = {
  pt: [
    ...
    ["A payer", "A pagar"],
    ["A recevoir", "A receber"],
    ["TOTAL COM IVA", "TOTAL COM IMPOSTOS"],
    ["Total com IVA", "Total com impostos"],
    ["Total sem IVA", "Total sem impostos"],
    ["IVA 10 %", "Imposto 10 %"],
    ["IVA 20 %", "Imposto 20 %"],
    ["Documents", "Documentos"],
    ["FACTURE n°", "FATURA n°"],
    ...
    ["Frota societe", "Frota da empresa"],
    ["Frota société", "Frota da empresa"],
    [" pl ·", " lugares ·"],
    [" pl ", " lugares "],
    ["Plaques enregistrées", "Placas registradas"],
    ["Plaques enregistrees", "Placas registradas"],
